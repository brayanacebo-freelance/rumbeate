	...
	<div id="file-toolbar">
		<div id="file-buttons">
			<ul class="button-menu-source buttons">
				<li class="btn blue small" data-applies-to="pane root-pane"	data-menu="refresh"><?php echo lang('files:refresh') ?></li>
				<li class="btn blue small" data-applies-to="folder" data-menu="open"><?php echo lang('files:open') ?></li>
				<li class="btn blue small" data-role="create_folder"	data-applies-to="pane root-pane" data-menu="new-folder"><?php echo lang('files:new_folder') ?></li>
				<li class="btn blue small" data-role="upload" data-applies-to="folder pane" data-menu="upload"><?php echo lang('files:upload') ?></li>
				<li class="btn blue small" data-role="edit_file" data-applies-to="file" data-menu="rename"><?php echo lang('files:rename') ?></li>
				<li class="btn blue small" data-role="edit_folder" data-applies-to="folder" data-menu="rename"><?php echo lang('files:rename') ?></li>
				<li class="btn blue small" data-role="download_file" data-applies-to="file" data-menu="download"><?php echo lang('files:download') ?></li>
				<li class="btn blue small" data-role="synchronize" data-applies-to="folder" data-menu="synchronize"><?php echo lang('files:synchronize') ?></li>
				<li class="btn blue small" data-role="upload delete_file" data-applies-to="file" data-menu="replace"><?php echo lang('files:replace') ?></li>
				<li class="btn blue small" data-role="delete_file" data-applies-to="file" data-menu="delete"><?php echo lang('files:delete') ?></li>
				<li class="btn blue small" data-role="delete_folder" data-applies-to="folder" data-menu="delete"><?php echo lang('files:delete') ?></li>
				<li class="btn blue small" data-applies-to="folder file pane"	data-menu="details"><?php echo lang('files:details') ?></li>
			</ul>
		</div>
