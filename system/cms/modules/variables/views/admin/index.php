		...
		<table border="0" class="table-list" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td class="actions">
						<?php echo anchor('admin/variables/edit/' . $variable->id, lang('buttons:edit'), 'class="btn blue small"') ?>
						<?php echo anchor('admin/variables/delete/' . $variable->id, lang('buttons:delete'), array('class'=>'btn red small')) ?>
					</td>
				</tr>
				<?php endforeach ?>
			</tbody>
