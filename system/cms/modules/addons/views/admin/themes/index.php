            ...
            <table class="table-list" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo isset($theme->options) ? anchor('admin/addons/themes/options/'.$theme->slug, lang('addons:themes:options'), 'title="'.$theme->name.'" class="btn green small"') : '' ?>
                            <a href="<?php echo $theme->screenshot ?>" rel="screenshots" title="<?php echo $theme->name ?>" class="button modal btn green small"><?php echo lang('buttons:preview') ?></a>
                            <?php if($theme->slug != 'admin_theme') { echo anchor('admin/addons/themes/delete/'.$theme->slug, lang('buttons:delete'), 'class="btn red small"'); } ?>
                        </td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
