        ...
        <table class="table-list" cellspacing="0">
            ...
            <?php foreach ($keywords as $keyword):?>
                <tr>
                    ...
                    <td class="actions">
                    <?php echo anchor('admin/keywords/edit/'.$keyword->id, lang('global:edit'), 'class="btn blue small"') ?>
                    <?php if ( ! in_array($keyword->name, array('user', 'admin'))): ?>
                        <?php echo anchor('admin/keywords/delete/'.$keyword->id, lang('global:delete'), 'class="btn red small"') ?>
                    <?php endif ?>
                    </td>
                </tr>
            <?php endforeach;?>
