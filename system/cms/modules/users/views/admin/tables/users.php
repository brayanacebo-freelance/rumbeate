            ...
            <tbody>
                ...
                <?php foreach ($users as $member): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo anchor('admin/users/edit/' . $member->id, lang('global:edit'), array('class'=>'btn blue small')) ?>
                            <?php echo anchor('admin/users/delete/' . $member->id, lang('global:delete'), array('class'=>'btn red small')) ?>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
