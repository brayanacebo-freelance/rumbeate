			...
			<div class="form_inputs" id="page-details">
				<div class="inline-form">
                    ...
                    <ul>
                        <li class="even">
                            <label for="title">
								<?php if ($page_type->title_label): echo lang_label($page_type->title_label); else: echo lang('global:title'); endif ?> 		
                                <span>*</span>
                                <small></small>
                            </label>
                            <div class="input">
								<?php echo form_input('title', $page->title, 'id="title" maxlength="60"') ?>
                            </div>
                            <br class="clear">
                        </li>
                        ...
                        <li class="even">
                            <label for="category_id">
								<?php echo lang('pages:status_label') ?>
                            </label>
                            <div class="input">
                        ...
                        <li>
                            <label for="navigation_group_id">
								<?php echo lang('pages:navigation_label') ?>
                            </label>
                            <div class="input">
                        ...
                        <ul>
                            ...
                            <?php endif; ?>
                                <li class="even">
                                    ...
                                    <div class="input">
                                        <label class="radio">
                                            <?php echo form_checkbox('meta_robots_no_index', true, $page->meta_robots_no_index == true, 'id="meta_robots_no_index"') ?>
                                        </label>
                                    </div>
                                    <br class="clear">
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="input">
                                        <label class="radio">
                                            <?php echo form_checkbox('meta_robots_no_follow', true, $page->meta_robots_no_follow == true, 'id="meta_robots_no_follow"') ?>
                                        </label>
                                    </div>
                                    <br class="clear">
                                </li>
