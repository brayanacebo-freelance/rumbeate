                            ...
                            <?php foreach ($page_types as $page_type): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <?php echo anchor('admin/pages/types/fields/'.$page_type->id, lang('global:fields'), array('class'=>'btn green small'));?> 
                                        <?php echo anchor('admin/pages/types/edit/' . $page_type->id, lang('global:edit'), array('class'=>'btn blue small'));?> 
                                        <?php if ($page_type->slug !== 'default') echo anchor('admin/pages/types/delete/' . $page_type->id, lang('global:delete'), array('class'=>'btn red small'));?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
