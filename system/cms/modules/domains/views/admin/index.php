    ...
    <div class="scroll-table">
        <table border="0" class="table-list" cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($domains as $domain): ?>
                ...
                <div class="actions">
                    <?php echo anchor('admin/domains/edit/' . $domain->id, lang('global:edit'), 'class="btn blue small"');?>
                    <?php echo anchor('admin/domains/delete/' . $domain->id, lang('global:delete'), array('class'=>'btn red small'));?>
                </div>
                </td>
                </tr>
            <?php endforeach ?>
