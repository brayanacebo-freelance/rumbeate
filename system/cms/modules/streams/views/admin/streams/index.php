...
<div class="scroll-table">		
    <table border="0" class="table-list" cellspacing="0">
        ...
        ?>
                ...
                <td class="actions">
                    <?php if(group_has_role('streams', 'admin_streams')): echo anchor('admin/streams/manage/' . $stream->id, lang('streams:manage'), 'class="btn green small"'); endif; ?> 
                    <?php echo anchor('admin/streams/entries/index/' . $stream->id, lang('streams:entries'), 'class="btn green small"');?> 
                    <?php echo anchor('admin/streams/entries/add/'.$stream->id, lang('streams:new_entry'), 'class="btn blue small"');?> 
