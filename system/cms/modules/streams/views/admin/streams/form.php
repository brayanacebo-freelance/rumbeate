...
<div class="form_inputs">
	...
	<div class="float-right buttons">
		...
		<?php if($this->uri->segment(3)=='add'): ?>
			...
			<a href="<?php echo site_url('admin/streams'); ?>" class="btn red"><?php echo lang('buttons:cancel'); ?></a>
		
		<?php else: ?>
		
			<a href="<?php echo site_url('admin/streams/manage/'.$stream->id); ?>" class="btn red"><?php echo lang('buttons:cancel'); ?></a>
