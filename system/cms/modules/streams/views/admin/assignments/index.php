    ...
    <table class="table-list">
		...
		<?php foreach ($stream_fields as $stream_field):?>
			<tr>
				...
				<td class="actions">
					<?php echo anchor('admin/streams/edit_assignment/'.$stream_field->stream_id . '/'.$stream_field->assign_id, lang('streams:edit_assign'), 'class="btn blue small"'); ?>
					<?php echo anchor('admin/streams/remove_assignment/'.$stream_field->stream_id . '/'.$stream_field->assign_id, lang('streams:remove'), 'class="btn red small"'); ?>
				</td>
			</tr>
		<?php endforeach;?>
		</tbody>
