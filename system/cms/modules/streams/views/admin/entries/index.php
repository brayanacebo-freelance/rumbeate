		...
		<?php foreach ($data as $field => $data_item):?>
			<tr>
				...
				<td class="actions">
					...
					<?php echo anchor('admin/streams/entries/edit/'.$stream->id.'/'.$data_item->id, lang('global:edit'), 'class="btn blue"'); ?>
					<?php echo anchor('admin/streams/entries/view/'.$stream->id.'/'.$data_item->id, lang('global:view'), 'class="btn green"'); ?>
					<?php echo anchor('admin/streams/entries/delete/'.$stream->id.'/'.$data_item->id, lang('global:delete'), 'class="btn red"'); ?>
