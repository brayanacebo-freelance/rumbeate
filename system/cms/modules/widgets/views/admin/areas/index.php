				...
				<section class="widget-area-box" id="area-<?php echo $widget_area->slug ?>" data-id="<?php echo $widget_area->id ?>">
					...
					<div class="widget-area-content accordion-content">
						<div class="area-buttons buttons buttons-small">
							...
							<?php echo anchor('admin/'.$this->module_details['slug'].'/areas/edit/'.$widget_area->slug, lang('global:edit'), 'class="btn blue"') ?>
							<button type="submit" name="btnAction" value="delete" class="btn red"><span><?php echo lang('global:delete') ?></span></button>
