        ...
        <div class="scroll-table">
            <table border="0" class="table-list" cellspacing="0">
                ...
                <?php foreach ($redirects as $redirect): ?>
                    ...
                    <div class="actions">
                        <?php echo anchor('admin/redirects/edit/' . $redirect->id, lang('redirects:edit'), 'class="btn blue small"');?>
                        <?php echo anchor('admin/redirects/delete/' . $redirect->id, lang('redirects:delete'), array('class'=>'btn red small'));?>
                    </div>
                    </td>
                    </tr>
                <?php endforeach ?>
