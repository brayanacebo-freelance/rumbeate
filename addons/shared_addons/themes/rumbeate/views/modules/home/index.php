 							...
 							<?php echo form_open_multipart(site_url('home/send'), 'class="crud form_contac_ajax"'); ?>        
 								<ul class="columna_1 large-7 medium-7 small-12">
 									...
 									<li class="campo large-6 medium-6 small-12 terminos">
 										...
 										<input id="checkbox1" type="checkbox" class="large-1 medium-1 small-1">
 									</li>
 									...
 									<li class="campo large-6 medium-6 small-12 politicas">
 										<label class="texto_check_2 large-9 medium-9 small-10"><a href="politicas.html" target="_blank" tittle="políticas de privacidad">Acepto las políticas de privacidad</a>
 										</label>
 										<input id="checkbox1" type="checkbox" class="large-1 medium-1 small-1">
 									</li>
 								</ul>
 									...
 									<li class="campo large-12 medium-12 small-12">
 										<div class="contenedor_subir_factura_2 large-12 medium-12 small-12">
 											<div class="texto_campo_examinar large-12 medium-12 small-12" >
													<!--  Campos ocultos para pruebas

													<input type="file" class="file" name="file" />
													<input type="file" class="campo_input" src="img/fondo_mecanica_texto.png"/>
