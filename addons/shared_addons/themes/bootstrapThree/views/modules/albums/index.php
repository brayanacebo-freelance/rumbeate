...
<?php
	...
	$menu = build_categories($categories,'albums', 0, true, $current, '', 1);
?>
...
<div class="row">
    <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <h1>albumos {{ category }}</h2>
    </div>
</div>
<div class="row">
    <!--  Texto de introducción administrable -->
    <div class="col-sx-12 col-sm-12 col-md-12 col-lg-12">
        <p style="margin:15px 0 30px 0;">{{ intro.text }}</p>
    </div>
    ...
    <div class="col-sm-6 col-md-3 visible-sm visible-xs">
        <div class="btn-group" style="margin-bottom: 10px;">
            ...
            {{ categories }}
            <li><a href="albums/index/{{ slug }}">{{ title }}</a></li>
            {{ /categories }}
            </ul>
        </div>
        <div class="push"></div>
    ...
    <div class="col-sm-6 col-md-9">
        <div class="row">
            ...
            <div class="ajax_loading" id="ajax_loading" style="display:none;"><img src="{{ url:site }}uploads/default/loading.gif" width="28" height="28"/></div>
            {{ else }}
