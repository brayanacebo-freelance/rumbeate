...
class Module_albums extends Module {
    ...
    public $chilTable = 'album_categories';
    public $imageTable = 'album_images';
    public $relationship = 'albums_categories';
    public $intro = 'albums_intro';
    ...
    public function info() {
        return array(
            ...
            'description' => array(
                'en' => 'albums © Brayan Acebo, luis fernando salazar 2014',
                'es' => 'albunes © Brayan Acebo, luis fernando salazar 2014',
            ),
            'frontend' => TRUE,
            'backend' => TRUE,
            'menu' => 'content'
    ...
    public function help() {
        return "Modulo de albunes con arbol de categorias y multiples imagenes";
    }
