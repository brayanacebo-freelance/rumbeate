<div class="container">
    <div class="row mtop70">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 alignleft">
            <h2 class="color-text-blue2"><?php echo $album->name; ?></h2>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 alignleft">
            <div class="thumbnail img-float-left">
                <div style="overflow: hidden;max-height:400px;">
                    ...
                    <?php }else{ ?>
                        <img src="<?php echo $album->image; ?>" data-src="holder.js/400x400" width="100%" alt="" class="img-responsive">
                    <?php } ?>
                </div>
            </div>
            <p><?php echo $album->description; ?></p>
            <small class="small-float"><?php echo $album->price; ?></small>
            <div class="row">
                <div class="col-md-12">
                    <div class="well well-sm" style="float: left;margin-top: 2em;">
                        <strong>Categorias relacionadas</strong><br>
                        <?php foreach ($categories as $category): ?>
                            <a href="albums/index/<?php echo $category['slug'] ?>"><?php echo $category['title'] ?></a>&nbsp;&nbsp;
                        <?php endforeach; ?>
                    </div>
                </div>
            </div>
