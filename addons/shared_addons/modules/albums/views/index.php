<?php
	...
	$menu = build_categories($categories,'albums', 0, true, $current);
?>
<div class="container">
    <div class="row mtop40">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h2 class="color-text-blue"><strong>albunes <?php echo $category; ?></strong></h2>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <div class="btn-group" style="margin-bottom: 10px;">
              ...
              <ul class="dropdown-menu">
                <?php foreach ($categories as $item): ?>
                    <li><a href="albums/index/<?php echo $item->slug ?>"><?php echo $item->title ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
        <div class="push"></div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <div style="overflow: hidden;max-height:170px;">
                            <img src="<?php echo $album->image; ?>" data-src="holder.js/300x200" width="100%" alt="" class="img-responsive">
                        </div>
                        <div class="caption">
                            <h4><?php echo $album->name ?></h4>
                            <p><?php echo $album->introduction ?></p>
                            <small class="small-float"><i><?php echo $album->price; ?></i></small><br>
                            <p><a class="btn btn-primary btn-sm" href="<?php echo $album->url ?>" >Ver Mas</a></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
