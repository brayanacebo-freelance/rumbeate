    ...
    <div class="content">
        <div class="tabs">
            ...
            <div class="form_inputs" id="page-category">
                <?php echo form_open_multipart(site_url('admin/products/update_category'), ''); ?>
                <div class="inline-form">
                    ...
                    <div class="buttons float-right padding-top">
                        ...
                        <a href="<?php echo backend_url('products#page-categories') ?>" class="btn red cancel">Cancelar</a>
                        <?php echo anchor('admin/products/destroy_category/' . $category->id, lang('global:delete'), array('class' => 'confirm btn red')); ?>
                    </div>
