<?php
	...
	$menu = build_categories($categories,$moduleName, 0, true, $current);
?>
<div class="container">
    <div class="row mtop40">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h2 class="color-text-blue"><strong>Archivos <?php echo $category; ?></strong></h2>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <div class="btn-group" style="margin-bottom: 10px;">
              ...
              <ul class="dropdown-menu">
                <?php foreach ($categories as $item): ?>
                    <li><a href="multi_upload_files/index/<?php echo $item->slug ?>"><?php echo $item->title ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
        <div class="push"></div>
    ...
    <div class="col-sm-6 col-md-9">
        <div class="row">
        <?php if($multi_upload_files): ?>
            <?php foreach ($multi_upload_files as $multi_upload_file): ?>
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <div style="overflow: hidden;max-height:170px;">
                            <img src="<?php echo $multi_upload_file->image; ?>" data-src="holder.js/300x200" width="100%" alt="" class="img-responsive">
                        </div>
                        <div class="caption">
                            <h4><?php echo $multi_upload_file->name ?></h4>
                            <p><?php echo $multi_upload_file->introduction ?></p>
                            <small class="small-float"><i><?php echo $multi_upload_file->price; ?></i></small><br>
                            <p><a class="btn btn-primary btn-sm" href="<?php echo $multi_upload_file->url ?>" >Ver Mas</a></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
