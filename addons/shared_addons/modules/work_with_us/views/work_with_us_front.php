<div class="container">
    ...
    <div class="row mtop10">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <?php echo form_open(site_url('work_with_us/send'), 'class="crud"'); ?>        
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <?php if(isset($work_with_us->map) && !empty($work_with_us->map)): ?>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <?php     
                       $map = str_replace("#", "%23", $work_with_us->map);
                       echo $map;
                  ?>
               </div>
            </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                <div class="cont_datos_contacto">
                    ...
                    <hr class="hr_title_seccion2">
                    <ul class="contacto">
                        <li>Dirección: <?php echo (isset($work_with_us->adress) ? $work_with_us->adress: ''); ?></li>
                        <li>Teléfono: <?php echo (isset($work_with_us->phone) ? $work_with_us->phone: ''); ?></li>
                        <li>E-mail: <?php echo (isset($work_with_us->email) ? $work_with_us->email: ''); ?></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                <div class="cont_datos_contacto">
                    ...
                    <hr class="hr_title_seccion2">
                    <ul class="contacto">
                        <li><?php echo (isset($work_with_us->schedule) ? $work_with_us->schedule: ''); ?></li>
                    </ul>
                </div>
            </div>
        </div>
