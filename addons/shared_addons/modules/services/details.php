...
class Module_services extends Module {
    ...
    public $version = '1.2';
    public $mainTable = 'services';
    public $chilTable = 'service_categories';
    public $imageTable = 'service_images';
    public $relationship = 'services_categories';
    public $intro = 'services_intro';
    ...
    public function info() {
        return array(
            ...
            'description' => array(
                'en' => 'services © Brayan Acebo, luis fernando salazar 2014',
                'es' => 'servicios © Brayan Acebo, luis fernando salazar 2014',
            ),
            'frontend' => TRUE,
            'backend' => TRUE,
            'menu' => 'content'
    ...
    public function help() {
        return "Modulo de servicios con arbol de categorias y multiples imagenes";
    }
