<?php
	...
	$menu = build_categories($categories,'services', 0, true, $current);
?>
<div class="container">
    <div class="row mtop40">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h2 class="color-text-blue"><strong>servicios <?php echo $category; ?></strong></h2>
        </div>
    </div>
    <br>
    <div class="row">
            ...
            <div class="btn-group" style="margin-bottom: 10px;">
              ...
              <ul class="dropdown-menu">
                <?php foreach ($categories as $item): ?>
                    <li><a href="services/index/<?php echo $item->slug ?>"><?php echo $item->title ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
        <div class="push"></div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <small class="small-float"><i><?php echo $service->price; ?></i></small><br>
