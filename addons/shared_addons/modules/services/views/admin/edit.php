...
<section class="item">
    <div class="content">
        <div class="tabs">
            <ul class="tab-menu">
                <li><a href="#page-service"><span>Editar Servicio</span></a></li>
            </ul>
            <div class="form_inputs" id="page-service">
                <?php echo form_open_multipart(site_url('admin/services/update'), 'id="form-wysiwyg"'); ?>
                <div class="inline-form">
                    <fieldset>
                        ...
                        <li>
                            ...
                            <div class="input">
                                <div class="input"><?php echo form_input('price', $service->price); ?></div>
                            </div>
                        </li>
                    </ul>
                </fieldset>
